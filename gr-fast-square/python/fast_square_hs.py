...
if __name__ == '__main__':
    ...
    parser.add_option("-a", "--address", dest="address", type="string", default="serial=7R24X9U1, fpga=usrp1_hs_bb.rbf",
        help="Set IP Address [default=%default]")
    parser.add_option("--address2", dest="address2", type="string", default="serial=9R24X1U1, fpga=usrp1_hs_bb.rbf",
        help="Set IP Address [default=%default]")
